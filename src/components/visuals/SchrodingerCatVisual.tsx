...
export default function SchrodingerCatVisual({ showStory }: { showStory: boolean }) {
  return (
    ...
    >
      <div className="bg-journey-accent/5 rounded-xl p-6 border border-journey-accent/20 space-y-6">
        <h3 className="font-bold text-journey-accent tracking-wide text-sm uppercase">Schrodinger's Cat — The Experiment</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
          <div className="md:col-span-1 bg-journey-surface rounded-lg p-4 border border-journey-accent/20 text-center">
            ...
            <div className="text-xs text-journey-muted font-medium mt-1">Step 1</div>
            <div className="text-[10px] text-journey-muted leading-relaxed mt-1">
          ...
          <div className="md:col-span-1 bg-journey-surface rounded-lg p-4 border border-journey-accent/20 text-center">
            ...
            <div className="text-xs text-journey-muted font-medium mt-1">Step 2</div>
            <div className="text-[10px] text-journey-muted leading-relaxed mt-1">
          ...
          <div className="md:col-span-1 bg-journey-surface rounded-lg p-4 border border-journey-accent/20 text-center">
            ...
            <div className="text-xs text-journey-muted font-medium mt-1">Step 3</div>
            <div className="text-[10px] text-journey-muted leading-relaxed mt-1">
          ...
          <div className="md:col-span-1 bg-journey-surface rounded-lg p-4 border border-journey-accent/20 text-center">
            ...
            <div className="text-xs text-journey-muted font-medium mt-1">Step 4</div>
            <div className="text-[10px] text-journey-muted leading-relaxed mt-1">
          ...
          <div className="md:col-span-1 bg-journey-surface rounded-lg p-4 border border-journey-accent/20 text-center">
            ...
            <div className="text-xs text-journey-muted font-medium mt-1">Outcome</div>
            <div className="text-[10px] text-journey-muted leading-relaxed mt-1">
        ...
        <div className="bg-journey-surface rounded-lg p-4 border border-journey-accent/20">
          <p className="text-xs text-journey-muted leading-relaxed">
            <strong className="text-journey-accent">The punchline:</strong> Schrodinger proposed this in 1935 to show that
            the Copenhagen interpretation leads to absurdity if taken literally — a cat cannot be both alive and dead.
            Modern physics resolves this via <strong className="text-journey-accent">decoherence</strong>: the cat interacts

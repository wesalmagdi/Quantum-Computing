...
export default function ModuleIntro() {
  ...
  return (
    <div className="space-y-10 max-w-4xl mx-auto">
      <div>
        <h2 className="text-3xl font-bold text-journey-text mb-3 tracking-tight">From Bits to Qubits</h2>
        <p className="text-journey-muted text-sm leading-relaxed">
          ...
          The difference between a <strong className="text-journey-text">bit</strong> and a
          <strong className="text-journey-text"> qubit</strong> is subtle but world-changing.
      ...
      <div className="bg-white rounded-xl p-6 border border-journey-border">
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="text-xs text-journey-primary hover:text-journey-primary font-medium px-3 py-1.5 rounded border border-journey-primary/30 hover:bg-journey-surface transition-colors"
          >
        ...
        {showKet && (
          <motion.div
            ...
            className="space-y-4 text-sm text-journey-muted leading-relaxed"
          >
            <p>
              The notation <span className="font-mono text-journey-primary">|0&gt;</span> is pronounced
              <strong className="text-journey-text"> &ldquo;ket zero&rdquo;</strong>. It comes from something called
              <strong className="text-journey-text"> Dirac notation</strong> (or bra-ket notation),
              invented by the physicist <strong className="text-journey-text">Paul Dirac</strong> in 1939.
            </p>
            <p>
              Think of it this way: a regular <span className="font-mono text-journey-text">0</span> is
              just a number. You can multiply it, add it, whatever. But
              <span className="font-mono text-journey-primary"> |0&gt;</span> means
              <strong className="text-journey-text"> &ldquo;the quantum state representing 0&rdquo;</strong>.
            ...
            <div className="bg-journey-surface rounded-lg p-4 font-mono text-sm space-y-2 border border-journey-border">
              <div className="text-journey-muted">{'0  --  just the number zero (classical)'}</div>
              <div className="text-journey-primary">{'|0>  --  "ket zero" = qubit in the 0 state'}</div>
              <div className="text-journey-accent">{'|1>  --  "ket one" = qubit in the 1 state'}</div>
              <div className="text-journey-muted">{'|psi>  --  "ket psi" = the qubit\'s current quantum state'}</div>
              <div className="text-journey-muted text-xs mt-2">(psi is the Greek letter, pronounced &ldquo;sigh&rdquo;)</div>
            </div>
            <p>
              The Greek letter <span className="font-mono text-journey-text">psi</span> is the universal
              symbol for a quantum state. So when you see
              <span className="font-mono text-journey-text"> |psi&gt; = alpha|0&gt; + beta|1&gt;</span>, it reads:
            </p>
            <p className="italic text-journey-muted pl-4 border-l-2 border-journey-border">
            ...
            <div className="bg-journey-surface rounded-lg p-4 border border-journey-primary/30">
              <p className="text-xs text-journey-primary leading-relaxed">
                ...
                <strong className="text-journey-text"> bra</strong> with a
                <strong className="text-journey-text"> ket</strong>, you get a
                <strong className="text-journey-text"> bra(c)ket</strong>. Physicists love wordplay.
              </p>
            </div>
          </motion.div>
        )}
      ...
      <div className="bg-white/50 rounded-xl p-5 border border-journey-border">
        <p className="text-sm text-journey-muted text-center leading-relaxed">
          ...
          <span className="text-journey-accent"> |1&gt;</span> &mdash; like a spinning coin.
          That &ldquo;blend&rdquo; is called <strong className="text-journey-text">superposition</strong>,

...
export default function ModuleMeasurement() {
  ...
  return (
    <div className="space-y-10 max-w-3xl mx-auto">
      <div>
        <h2 className="text-3xl font-bold text-journey-text mb-3 tracking-tight">Measurement</h2>
        <p className="text-journey-muted text-sm leading-relaxed max-w-2xl">
          ...
          it is a blend of <span className="text-journey-primary">|0&gt;</span> and
          <span className="text-journey-accent"> |1&gt;</span>. But the moment you measure it,
          <strong className="text-journey-text"> the superposition collapses</strong> to a single definite
          outcome -- either <span className="text-journey-primary">|0&gt;</span> or
          <span className="text-journey-accent"> |1&gt;</span>. Which one? It is
          <strong className="text-journey-text"> random</strong> -- but the odds follow the probabilities
          you have set.
        </p>
      </div>
        ...
        >
          ...
          <div className="bg-journey-surface rounded-lg p-4 border border-journey-border mb-5">
            <p className="text-xs text-journey-muted leading-relaxed">
              We ran <strong className="text-journey-text">1,000</strong> identical experiments on the same
              ...
              <strong className="text-journey-text"> frequentist interpretation</strong> of probability:
          ...
          <div className="grid grid-cols-2 gap-6 mb-6">
            <div className="text-center">
              <div className="text-4xl font-bold text-journey-primary">{results.zeros}</div>
              <div className="text-xs text-journey-muted">out of {total}</div>
              <div className="text-sm text-journey-muted mt-1">({((results.zeros / total) * 100).toFixed(1)}%)</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-journey-accent">{results.ones}</div>
              <div className="text-xs text-journey-muted">out of {total}</div>
              <div className="text-sm text-journey-muted mt-1">({((results.ones / total) * 100).toFixed(1)}%)</div>
            </div>
          </div>
          ...
          <div className="bg-journey-surface rounded-lg p-4 border border-journey-primary/30">
            <p className="text-xs text-journey-primary leading-relaxed">
              ...
              <strong className="text-journey-text"> law of large numbers</strong> in action.
